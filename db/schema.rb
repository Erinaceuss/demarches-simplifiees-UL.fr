...
ActiveRecord::Schema.define(version: 2019_05_20_122215) do
  ...
  create_table "administrateurs", id: :serial, force: :cascade do |t|
    ...
    t.string "login"
    t.index ["login"], name: "index_administrateurs_on_login", unique: true
  ...
  create_table "gestionnaires", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "features", default: {}, null: false
    t.string "login"
    t.index ["login"], name: "index_gestionnaires_on_login", unique: true
